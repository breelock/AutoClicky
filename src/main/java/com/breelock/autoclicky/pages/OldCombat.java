...
public class OldCombat extends Screen {
    ...
    public void init() {
        ...
        this.addButton(new ButtonWidget(this.width / 2 - 50, startY - spacing + 7, 100, 20, new LiteralText(new TranslatableText(ModConfig.pvpSystems.get(0)).getString()), button -> {
            save(false);
