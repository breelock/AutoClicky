...
public class NewCombat extends OldCombat {
    ...
    public void init() {
        ...
        addDrawableChild(new ButtonWidget(this.width / 2 - 50, startY - spacing + 7, 100, 20, new LiteralText(new TranslatableText(ModConfig.pvpSystems.get(1)).getString()), button -> {
            save(true);
